...
export default function PrivacyPage() {
  useEffect(() => {
    // Set dark background for privacy page
  ...
  return (
    <main className="wrap">
      <div className="card" role="main" aria-labelledby="privacy-heading">
        ...
        <ul>
          ...
          <li><strong>Application</strong> refers to Tilawah, the software program provided by the Company.</li>
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Tilawah.</li>
        ...
        <p>By email: <a href="mailto:ibrahim@tilawahapp.com">ibrahim@tilawahapp.com</a></p>
      </div>
    </main>
  )
}
